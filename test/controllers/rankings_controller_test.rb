...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { racket_id: @ranking.racket_id, rank: @ranking.rank, ranking_month: @ranking.ranking_month, ranking_week: @ranking.ranking_week, ranking_year: @ranking.ranking_year } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { racket_id: @ranking.racket_id, rank: @ranking.rank, ranking_month: @ranking.ranking_month, ranking_week: @ranking.ranking_week, ranking_year: @ranking.ranking_year } }
