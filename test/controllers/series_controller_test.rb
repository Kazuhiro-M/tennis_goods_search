...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { maker_id: @series.maker_id, name: @series.name } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { maker_id: @series.maker_id, name: @series.name } }
